...
if ($_SERVER['REQUEST_METHOD'] == "POST") {
    if (isset($_POST['delete_cart_submit'])) {
        $deletedrec = $Cart->deletecart($_POST['item_id']);
    }
}
?>
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center mt-2">
                    ...
                    <div class="border-top py-4">
                        <!-- When I delete a cart item and there isnot any item in the cart subtotal shows error as count of subtotal is empty -->

                        <h5 class="font-baloo font-size-20">Subtotal (<?php echo count($product->getData('cart')) ?>):&nbsp; <span class="text-danger">$
